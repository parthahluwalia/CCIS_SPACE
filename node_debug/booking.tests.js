...
describe("Booking Tests", function() {
    ...
    it("A booking should contain _id", function (done) {
        expect(true).to.be.true;
    });

    it("A booking should contain startTime", function (done) {
        expect(true).to.be.true;
    });


    it("A booking should contain endTime", function (done) {
        expect(true).to.be.true;
    });


    it("A booking should contain purpose", function (done) {
        expect(true).to.be.true;
    });


    it("A booking should contain status", function (done) {
        expect(true).to.be.true;
    });


    it("A booking should contain priority", function (done) {
        expect(true).to.be.true;
    });


    it("A booking should contain createDate", function (done) {
        expect(true).to.be.true;
    });


    it("A booking should contain room ", function (done) {
        expect(true).to.be.true;
    });


    it("A booking should contain requestor", function (done) {
        expect(true).to.be.true;
    });
